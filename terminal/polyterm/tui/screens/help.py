...
def help_screen(console: RichConsole):
    ...
    features.add_row("🛡️", "[bold]Risk:[/bold] Market risk assessment with A-F grades")
    features.add_row("👥", "[bold]Copy Trading:[/bold] Follow successful wallets")
    features.add_row("🎰", "[bold]Parlay:[/bold] Combine multiple bets for higher payouts")
    features.add_row("🔖", "[bold]Bookmarks:[/bold] Save and manage favorite markets")
    features.add_row("📊", "[bold]Dashboard:[/bold] Quick overview of market activity")
    features.add_row("📉", "[bold]Charts:[/bold] ASCII price history visualization")
    features.add_row("⚖️", "[bold]Compare:[/bold] Side-by-side market comparison")
    features.add_row("🎯", "[bold]Size:[/bold] Kelly Criterion position calculator")
    features.add_row("🕐", "[bold]Recent:[/bold] Recently viewed markets history")
    features.add_row("🔔", "[bold]Price Alerts:[/bold] Notify when prices hit targets")
    features.add_row("📅", "[bold]Calendar:[/bold] Upcoming market resolutions")
    features.add_row("💰", "[bold]Fees:[/bold] Trade cost and slippage calculator")
    features.add_row("📈", "[bold]Stats:[/bold] Volatility, RSI, trend analysis")
    features.add_row("🔍", "[bold]Search:[/bold] Advanced filters for finding markets")
    ...
    features.add_row("💵", "[bold]Trade:[/bold] Quick pre-trade analysis")
    features.add_row("📆", "[bold]Timeline:[/bold] Visual resolution timeline")
    features.add_row("📊", "[bold]Analyze:[/bold] Portfolio exposure analytics")
    features.add_row("📒", "[bold]Journal:[/bold] Trade documentation")
    features.add_row("🔥", "[bold]Hot:[/bold] Biggest market movers")
    features.add_row("💰", "[bold]P&L:[/bold] Profit/loss tracking")
    features.add_row("🔍", "[bold]Lookup:[/bold] Quick market info")
    features.add_row("🔔", "[bold]Alert Center:[/bold] Unified alert view")
    features.add_row("📁", "[bold]Groups:[/bold] Organize markets into collections")
    features.add_row("📊", "[bold]Attribution:[/bold] Performance by category/side/size")
    features.add_row("📸", "[bold]Snapshot:[/bold] Save and compare market states")
    features.add_row("📈", "[bold]Signals:[/bold] Entry/exit timing signals")
    features.add_row("🔗", "[bold]Similar:[/bold] Find related markets")
    features.add_row("📊", "[bold]Ladder:[/bold] Visual price ladder")
    features.add_row("🏆", "[bold]Benchmark:[/bold] Compare to market average")
    features.add_row("📌", "[bold]Pin:[/bold] Quick access favorites")
    features.add_row("💱", "[bold]Spread:[/bold] Bid/ask spread analysis")
    features.add_row("📜", "[bold]History:[/bold] Market price/volume history")
    features.add_row("🔥", "[bold]Streak:[/bold] Win/loss streak tracking")
    features.add_row("📰", "[bold]Digest:[/bold] Daily/weekly summaries")
    features.add_row("⏱️", "[bold]Timing:[/bold] Optimal trade timing")
    features.add_row("🔢", "[bold]Odds:[/bold] Convert probability/decimal/american/fractional")
    features.add_row("❤️", "[bold]Health:[/bold] Portfolio health score and grades")
    features.add_row("🎲", "[bold]Scenario:[/bold] What-if outcome modeling")
    features.add_row("👁", "[bold]Watchdog:[/bold] Continuous condition monitoring")
    features.add_row("📊", "[bold]Volume:[/bold] Volume profile at price levels")
    features.add_row("🔍", "[bold]Screener:[/bold] Multi-criteria market filter")
    features.add_row("📈", "[bold]Backtest:[/bold] Test trading strategies")
    features.add_row("📄", "[bold]Report:[/bold] Generate trading reports")
    features.add_row("💧", "[bold]Liquidity:[/bold] Cross-market liquidity comparison")
    features.add_row("📊", "[bold]EV:[/bold] Expected value and Kelly calculator")
    features.add_row("🎯", "[bold]Calibrate:[/bold] Track prediction accuracy")
    features.add_row("⚡", "[bold]Quick:[/bold] Fast access to common actions")
    features.add_row("🏆", "[bold]Leaderboard:[/bold] Top trader rankings")
    features.add_row("🔔", "[bold]Notify:[/bold] Configure notifications")
